package com.emc.inheritance.exercise;
...
public class Principal {
	...
	public static void main(String[] args) {
		...
		listaElectrodomesticos[8] = new Television(200, 60, 'C', "naranja", 30,
				true);
		...
		for (int i = 0; i < listaElectrodomesticos.length; i++) {
			/*
			 * Cuando una Television o una Lavadora este en la posicion del
			 * array actual, pasara por su clase y por la de electrodomestico,
			 * ya que una television es un electrodomestico. Ejecutamos en cada
			 * uno su propia version del metodo precioFinal
			 */

			if (listaElectrodomesticos[i] instanceof Electrodomestico) {
				sumaElectrodomesticos += listaElectrodomesticos[i]
						.precioFinal();
			}
